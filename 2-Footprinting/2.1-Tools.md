...
# 3. Firewall Bypass (TCP Trace - Red Team Essential)
...
# 4. ICMP Trace (Windows Emulation)
# Use this on Linux to behave like the Windows 'tracert' command.
traceroute -I target.com

# 5. Debugging Latency
# Increase wait time if the network is very slow or lossy.
...
<img src="../images/Footprinting/Wappalyzer.png">

Wappalyzer is a technology profiler that shows you what websites are built with. It uncovers content management systems (CMS), eCommerce platforms, web servers, JavaScript frameworks, and analytics tools. It can be used to quickly identify vulnerable software versions without sending aggressive packets. It is a tactical, real-time fingerprinting of the viewed page.

> - Navigate to: *https://www.wappalyzer.com/*
> - Limitation: You'll need to sign up to get 50 technology lookups per month. Subscribe to their plan to get more lookups.

```bash

# Later do this part research a bit
...
<img src="../images/Footprinting/builtWith.png">
...
> Navigate to: *https://builtwith.com/*

<!-- Detail the usage of this tool with a real use case scenario -->
1. Technology Stack Enumeration
 - Select a targetted website
 - Identify Webservers, CMS platforms, and framework versions
 - Discover outdated software vunerable to know exploits.
 - Map JavaScript libraries  (jQuery, Bootstrap) for client-side vulnerabilities.

2. Infrastructure Mapping
- Find hosting providers and CDN configurations
- Identify SSL/TLS certificate details for related domain discovery
- Discover name servers and DNS infrastructure

3. Relationship Discovery
- Track shared Analytics IDs (Google Analytics, Facebook Pixel) across multiple domains
- Find parent companies and subsidiary websites
- Identify all properties using the same infrastructure

4. Attack Surface Expansion
- Locate third-party integrations and plugins
- Discover email services for phishing vector analysis
- Find communication tools (Slack, Teams) for social engineering prep

5. Historical Analysis
- View technology changes over time to identify migration windows
- Detect recently added technologies that may not be fully hardened
- Find abandoned or forgotten systems still using legacy tech
...
View historical snapshots of websites to find old content, removed pages, or previous configurations.
...
Gathering email addresses helps identify potential targets for phishing or social engineering attacks.
