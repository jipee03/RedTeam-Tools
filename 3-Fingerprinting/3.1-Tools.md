...
> **External References:**
> * [**PEASS-ng (WinPEAS & LinPEAS)**](https://github.com/carlospolop/PEASS-ng) - Automated scripts to search for privilege escalation vectors on Windows and Linux.
> * [**SecLists**](https://github.com/danielmiessler/SecLists) - The standard collection of wordlists for fuzzing, username enumeration, and discovery.
> * [**HackTricks (Enumeration)**](https://book.hacktricks.xyz/) - The comprehensive encyclopedia for manual enumeration techniques.
